...
OBOBOB  information both about supported versions of Node.js and supported Linux
  distributions. To learn more about usage, see the repository:
OBOBOB    ${bold}https://github.com/nodesource/distributions${normal}
"
OBOBOB        echo
...
OBOBOBcheck_alt "Linux Mint"     "sarah"           "Ubuntu"        "xenial"
check_alt "Linux Mint"     "serena"          "Ubuntu"        "xenial"
OBOBOBcheck_alt "Linux Mint"     "sonya"           "Ubuntu"        "xenial"
check_alt "Linux Mint"     "sylvia"          "Ubuntu"        "xenial"
check_alt "Linux Mint"     "tara"            "Ubuntu"        "bionic"
OBOBOBcheck_alt "Linux Mint"     "tessa"           "Ubuntu"        "bionic"
